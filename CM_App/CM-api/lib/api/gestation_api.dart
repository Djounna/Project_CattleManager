...
class GestationApi {
  ...
  /// Performs an HTTP 'GET /api/Gestation/{cowId}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [int] cowId (required):
  Future<Response> apiGestationCowIdGetWithHttpInfo(
    int cowId,
  ) async {
    // ignore: prefer_const_declarations
    final path =
        r'/api/Gestation/{cowId}'.replaceAll('{cowId}', cowId.toString());
  ...
  ///
  /// * [int] cowId (required):
  Future<List<GestationDto>?> apiGestationCowIdGet(
    int cowId,
  ) async {
    final response = await apiGestationCowIdGetWithHttpInfo(
      cowId,
    );
