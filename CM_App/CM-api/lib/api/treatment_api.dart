...
class TreatmentApi {
  ...
  /// Performs an HTTP 'GET /api/Treatment/{cowId}' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [int] cowId (required):
  Future<Response> apiTreatmentCowIdGetWithHttpInfo(
    int cowId,
  ) async {
    // ignore: prefer_const_declarations
    final path =
        r'/api/Treatment/{cowId}'.replaceAll('{cowId}', cowId.toString());
  ...
  ///
  /// * [int] cowId (required):
  Future<List<TreatmentDto>?> apiTreatmentCowIdGet(
    int cowId,
  ) async {
    final response = await apiTreatmentCowIdGetWithHttpInfo(
      cowId,
    );
