...
export namespace Jobs{
    ...
    export class GetAllDetailsByUserByDate{
        static readonly type ='[Jobs] Get All Jobs Details By User By Date'
        constructor(public authId: string, public date: string){}
    }
